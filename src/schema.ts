...
const waitlistStatus = z.enum([WAITLIST_STATUS.PENDING, WAITLIST_STATUS.ACCEPTED, WAITLIST_STATUS.REJECTED] as const).optional().default(WAITLIST_STATUS.PENDING);
